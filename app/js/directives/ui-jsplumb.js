...
angular.module('ui.jsplumb', [])
  .constant('jsplumbConfig', {})
  .directive('jsPlumb', ['jsplumbConfig', function (jsplumbConfig) {
    if (angular.isUndefined(window.jsplumb)) {
    ...
    return {
      ...
      link: function (scope, elm, attrs, ngModel) {
        ...
        options = jsplumbConfig || {};
        opts = angular.extend({}, options, scope.$eval(attrs.jsPlumb));
